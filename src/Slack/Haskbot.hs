...
--   uses Slack's /incoming/ and /slash command/ service integrations to provide
--   a platform for adding custom slash commands with arbitrary responses to
--   your team's Slack service.
--
